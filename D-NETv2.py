...
from D_CNN import GlobalAvgPool2d, NetUnit1, NetUnit2, ConvTUnit
import torch
...
logging.basicConfig(filename='log.txt', level=logging.DEBUG, format='%(filename)s - %(message)s')
...
class DNet(nn.Module):
    ...
    def __init__(self, **kwargs):
        ...
        self.layer1.add_module('L1_IVNet_3', NetUnit1(6, 6, 3, 1, 1))
        self.layer1.add_module('L1_IVNet_4', NetUnit1(6, 6, 3, 1, 1))
        self.layer1.add_module('L1_VNet_5', NetUnit2(6, 6, 11, 2, 5))
        self.layer1.add_module('L1_BNLayer', nn.BatchNorm2d(6))
        self.layer1.add_module('L1_Drop',nn.Dropout2d(0.5))

        self.layer2.add_module('L2_IVNet_1', NetUnit1(6, 6, 5, 1, 2))
        self.layer2.add_module('L2_IVNet_2', NetUnit1(6, 6, 5, 1, 2))
        self.layer2.add_module('L2_IVNet_3', NetUnit1(6, 6, 3, 1, 1))
        self.layer2.add_module('L2_IVNet_4', NetUnit1(6, 6, 3, 1, 1))
        self.layer2.add_module('L2_IVNet_5', NetUnit1(6, 16, 3, 1, 1))
        ...
        self.layer2.add_module('L2_Drop',nn.Dropout2d(0.3))

        self.layer3.add_module('L3_IVNet_1', NetUnit1(16, 16, 3, 1, 1))
        self.layer3.add_module('L3_IVNet_2', NetUnit1(16, 16, 3, 1, 1))
        self.layer3.add_module('L3_IVNet_3', NetUnit1(16, 16, 3, 1, 1))
        self.layer3.add_module('L3_IVNet_4', NetUnit1(16, 16, 3, 1, 1))
        self.layer3.add_module('L3_IVNet_5', NetUnit1(16, 16, 3, 1, 1))
        self.layer3.add_module('L3_IVNet_6', NetUnit1(16, 16, 3, 1, 1))
        self.layer3.add_module('L3_IVNet_7', NetUnit1(16, 32, 3, 1, 1))
        ...
        self.layer3.add_module('L3_Drop',nn.Dropout2d(0.3))
        ...
        self.layer4.add_module('L4_Drop',nn.Dropout2d(0.3))
    ...
    with tqdm(total=40, bar_format='{postfix[0]}: {postfix[5][epoch]} | {postfix[1]}: {postfix[5][loss]} | '
        ...
        for epoch in range(num_epochs):
            ...
            for X, y in train_iter:
                ...
                n += y.shape[0]
                batch_count += 1
            test_acc = d2l.evaluate_accuracy(test_iter, net) / (512 ** 2)

            t.postfix[5]['epoch'] = epoch + 1
            t.postfix[5]['loss'] = round(train_l_sum / batch_count, 4)
            t.postfix[5]['train_acc'] = round(train_acc_sum / n, 2)
            t.postfix[5]['test_acc'] = round(test_acc, 2)
...
if __name__ == '__main__':
    ...
    data_iter = Data.DataLoader(data, 25, shuffle=True)
